...
// Code is generated on: 17/08/2022 22:25:42
//
...
namespace AnimaliContext
{
    ...
    public partial class Altro : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"Tipo_animale", Storage = "_TipoAnimale", CanBeNull = false, DbType = "CHAR(20) NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Cane : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Razza", CanBeNull = false, DbType = "CHAR(20) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string Razza
        {
            get
            {
    ...
    public partial class Gabbia : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private string _Lunghezza;

        private string _Larghezza;
        ...
        partial void OnCodiceGabbiaChanging(int value);
        partial void OnCodiceGabbiaChanged();
        partial void OnLunghezzaChanging(string value);
        partial void OnLunghezzaChanged();
        partial void OnLarghezzaChanging(string value);
        ...
        /// </summary>
        [Column(Name = @"lunghezza", Storage = "_Lunghezza", CanBeNull = false, DbType = "CHAR(1) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        ...
        /// </summary>
        [Column(Name = @"larghezza", Storage = "_Larghezza", CanBeNull = false, DbType = "CHAR(1) NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Medicinale : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Name = @"Descrizione_uso", Storage = "_DescrizioneUso", CanBeNull = false, DbType = "CHAR(50) NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Persona : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Nome", CanBeNull = false, DbType = "CHAR(30) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string Nome
        {
            get
            {
        ...
        /// </summary>
        [Column(Storage = "_Cognome", CanBeNull = false, DbType = "CHAR(30) NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class Vaccino : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Descrizione", CanBeNull = false, DbType = "CHAR(50) NOT NULL", UpdateCheck = UpdateCheck.Never)]
    ...
    public partial class VisitaMedica : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for DescrizioneSintomi in the schema.
        /// </summary>
        [Column(Name = @"Descrizione_sintomi", Storage = "_DescrizioneSintomi", CanBeNull = false, DbType = "CHAR(40) NOT NULL", UpdateCheck = UpdateCheck.Never)]
        public string DescrizioneSintomi
        {
            get
            {
